...
pub fn new_variant(node_type: &str, config: &SoundConfig) -> Result<NodeVariant, NodeError> {
    match node_type {
        ...
        "MidiFilterNode" => Ok(OscFilterNode::new(config).into()),
        ...
        "MidiToValueNode" => Ok(OscToValueNode::new(config).into()),
...
pub fn variant_io(
    ...
    match node_type {
        ...
        "MidiFilterNode" => Ok(OscFilterNode::get_io(ctx, props)),
        ...
        "MidiToValueNode" => Ok(OscToValueNode::get_io(ctx, props)),
